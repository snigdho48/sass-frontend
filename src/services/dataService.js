...
export const dataService = {
  ...
  async getDataEntries(filters = {}) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to fetch data entries'));
    }
  },
  ...
  async createDataEntry(entryData) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to create data entry'));
    }
  },
  ...
  async updateDataEntry(id, entryData) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to update data entry'));
    }
  },
  ...
  async deleteDataEntry(id) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to delete data entry'));
    }
  },
  ...
  async getDashboardData() {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to fetch dashboard data'));
    }
  },
  ...
  async getParameterTrends(systemType, parameterName, months = 6) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to fetch parameter trends'));
    }
  },
    ...
    try {
      ...
      if (error.response?.data instanceof Blob) {
        try {
          ...
          if (parseError instanceof Error && parseError.message !== 'Failed to generate report') throw parseError;
  ...
  async getPlantsManagement(params = {}) {
    try {
      const response = await api.get('/plants-management/', {
        params: { ...params, _t: Date.now() },
      });
      return response.data;
    } catch (error) {
      throw new Error(getApiErrorMessage(error, 'Failed to fetch plants for management'));
    }
  },
  ...
  async createPlant(plantData) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to create plant'));
    }
  },
  ...
  async updatePlant(plantId, plantData) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to update plant'));
    }
  },
  ...
  async deletePlant(plantId) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to delete plant'));
    }
  },
  ...
  async getUsersForPlantAccess() {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to fetch users for plant owner assignment'));
    }
  },
  ...
  async getAdminUsersForPlantCreation() {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to fetch admin users for plant creation'));
    }
  },
  ...
  async getWaterSystems(params = {}) {
    try {
      const response = await api.get('/water-systems/', { params: { ...params, _t: Date.now() } });
      return Array.isArray(response.data) ? response.data : (response.data?.results || response.data || []);
    } catch (error) {
      throw new Error(getApiErrorMessage(error, 'Failed to fetch water systems'));
    }
  },

  async getWaterSystemsByPlant(plantId) {
    try {
      const response = await api.get('/water-systems/', { params: { plant_id: plantId, _t: Date.now() } });
      const data = response.data;
      return Array.isArray(data) ? data : (data?.results || data || []);
    } catch (error) {
      throw new Error(getApiErrorMessage(error, 'Failed to fetch water systems for plant'));
    }
  },
  ...
  async createWaterSystem(waterSystemData) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to create water system'));
    }
  },
  ...
  async updateWaterSystem(waterSystemId, waterSystemData) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to update water system'));
    }
  },
  ...
  async deleteWaterSystem(waterSystemId) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to delete water system'));
    }
  },
  ...
  async assignUsersToWaterSystem(waterSystemId, userIds) {
    try {
      ...
      throw new Error(getApiErrorMessage(error, 'Failed to assign users to water system'));
    }
  },
}; 